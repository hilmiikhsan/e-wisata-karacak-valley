                                    ...
                                    <tbody>
                                        @foreach ($galleries as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->judul }}</td>
                                                <td>
                                                    <a href="{{ route('dashboard.gallery.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                                    <form method="POST" action="{{ route('dashboard.gallery.destroy', $item->id) }}" class="d-inline-block">
                                                        @csrf
                                                        @method('DELETE')
