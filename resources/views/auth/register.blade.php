...
<head>
  ...
  <![endif]-->
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset('/') }}img/kuningan.png" type="image/x-icon">
    ...
    <style>
        .auth-wrapper.auth-v3 {
            background: linear-gradient(to right, #17C666 50%, #fff 0);
        }
        ...
        <div class="card">
            <div class="row align-items-stretch text-center">
                <div class="col-md-6 img-card-side">
                    ...
                    <img src="{{ asset('img/logo-karacak.png') }}" alt="" class="img-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Nama Lengkap" autofocus>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i data-feather="user"></i></span>
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input type="password" id="password-confirm" name="password_confirmation" class="form-control @error('password-confirm') is-invalid @enderror" placeholder="Password (Confirm)">
                            </div>
