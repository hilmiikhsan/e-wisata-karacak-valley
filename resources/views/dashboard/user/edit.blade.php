                            ...
                            <form method="POST" action="{{ route('dashboard.user.update', $user->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <img src="{{ $user->avatar == '' ? asset('img/default.jpg') : url(Storage::url($user->avatar)) }}" alt="" width="200">
                                        <br>
                                        <label>Avatar</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="phone" placeholder="Nomor Handphone" value="{{ $user->phone }}" required>
                                    </div>
                                </div>
